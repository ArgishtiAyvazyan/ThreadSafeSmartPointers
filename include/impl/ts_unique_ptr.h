#ifndef THREADSAFESMARTPOINTERS_TS_UNIQUE_PTR_H
#define THREADSAFESMARTPOINTERS_TS_UNIQUE_PTR_H

/**
 * @file        ts_unique_ptr.h
 * @author      Argishti Ayvazyan (ayvazyan.argishti@gmail.com)
 * @brief       Declaration and implementations of thread-safe unique_ptr.
 * @date        7/21/2021.
...
#endif //THREADSAFESMARTPOINTERS_TS_UNIQUE_PTR_H
